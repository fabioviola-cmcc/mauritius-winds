...
dirin=./workdir_12/IN/
dirwork=./workdir_12/tmp/
dirout=./workdir_12/OUT/
...
for d in $(seq 1 5); do
    ...
    # copy original data
    echo "[$APPNAME] -- Copying original files /data/inputs/metocean/rolling/atmos/ECMWF/IFS_010/1.0forecast/1h/grib/${pyear}${pmonth}${pday}/JLS${pmonth}${pday}1200${rmonth}${rday}*"
